...
/*Mi explicación:
 * 
 * Esto puede ser engañoso a simple vista parece que todo esta bien y la respuesta 
 * parece ser que es la B Sin embargo como se observa le falto el ; 
 * a la declaración de la clase anónima
 * 
 ...
 * que la compilación falla porque hay un error en las lineas que no sean 3, 4 ,8
 * 
 * */