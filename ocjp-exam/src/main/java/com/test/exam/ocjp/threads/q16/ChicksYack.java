 ...
 *  y entonces si ya cada thread conoce a c y no es null, por lo que si fuerá así las respuestas serían  C y E, ya que entraian los 2 threads
 *  a ejecutar el método yack uno despues del otro porque son sincronizados
