 ...
 * Además la isntrucción laurel.wait(); si hace refrencia a laurel ya que no es static, si queremos corregir esto entonces sincronizamos esta instrucción
 * y al hacerlo ya no imrprimira 'E' porque ya no entrará al catch.
 * 
 * Esto nos lleva a el método run de laurel lo anterior fue para hardy...ahora es l turno de laurel, hay que prestar atención en la instrucción hardy.sleep(1000);
 ...
 * Correcta:
 * 	A, C, D, E, and F
 *  Esas letras aparecen eventualemnte debido a la explicación anterior no hay que olvidarse de cuando se usa synchronized ya que solo es para wait,notify y notifyAll
