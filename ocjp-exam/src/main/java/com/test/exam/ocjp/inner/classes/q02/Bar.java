 ...
 *  C también es correcta porque define una clase anónima y dentro empieza a declarar  
 *  código en este caso solo declara unavariable String s.
 *  
 *  A es incorrecta porque cuando trata de crear la clase anónima le pasa a su constructor 
